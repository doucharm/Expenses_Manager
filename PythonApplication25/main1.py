...
def main():
    ...
    button1 = Button( main_menu, text = "Add expense",command=lambda:add_expenses(main_menu,options_list))
    button2 = Button( main_menu, text = "Show expenses",command=lambda:Show_Expenses(main_menu))
    button3 = Button( main_menu, text = "Analyze",command=lambda:Analize_Data.Analize_Expenses(main_menu,options_list))
